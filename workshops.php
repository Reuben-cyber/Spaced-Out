...
?>
	<body>
	<center><h1 style="margin-top: 9vw; font-size: 3.5vw;">Workshops</h1></center>
		<?php
		include 'conn.php';
    $query = "SELECT * FROM space_list WHERE c_name='workshop'and verified='v'";
...
?> 
        ...
        <td style="width:30%">
            ...
            <img src="<?php echo $imageURL; ?>" alt="workshops" />
        </td>
        <td style="width:70%">
