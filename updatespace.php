...
<?php
		...
		$_SESSION['spaceid']=$prod_id;
    $query = "SELECT * FROM space_list WHERE space_id=$prod_id";
    $result = mysqli_query($con1,$query);
    while($res = mysqli_fetch_array($result)) {  
	
	?>
<form action="updatespace1.php" method="POST" class="main_form" enctype="multipart/form-data">

 <input type="text" name="Name" id="Name" placeholder="Enter Space Name" value="<?php echo $res ["space_name"];?>"required>
 <input type="textarea" name="Add" id="Add" placeholder="Enter the Address" value="<?php echo $res ["space_address"];?>"required>
 <input type="text" name="Phone" id="Phone" placeholder="Enter Contact Number" value="<?php echo $res ["phone"];?>"required>
 <select name="Category" id="Category" value="<?php echo $res ["c_name"];?>" >
 ...
 <input type="textarea" name="Description" id="Description" placeholder="Describe in Short" value="<?php echo $res ["space_description"];?>" >
