...
?>
	<body>
	<center><h1 style="margin-top: 9vw; font-size: 3.5vw;">Banquets</h1></center>
		<?php
		include 'conn.php';
    $query = "SELECT * FROM space_list WHERE c_name='banquets' and verified='v'";
...
?> 
        ...
        <td style="width:30%">
            ...
            <img src="<?php echo $imageURL; ?>" alt="banquets" />
        </td>
        <td style="width:70%">
